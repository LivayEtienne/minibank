...
class ClientController extends Controller
{
    ...
    public function index() 
    {
        ...
        $transactions = Transaction::with(['sourceUser', 'destinationUser'])
        ->where('id_compte_source', $user->id)
       ...
       /* $transactions = Transaction::where('id_compte_source', $client->id)
            ->orWhere('id_compte_destinataire', $client->id)
            ->orWhere('id_compte_destinatraire', $client->id) // Inclure l'ID du distributeur directement
            ->orderBy('created_at', 'desc')
            ->paginate(10);*/
