...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('transactions', function (Blueprint $table) {
            ...
            $table->foreignId('id_distributeur')->references('id')->on('distributeurs')->onDelete('cascade');
            ...
            $table->decimal('frais', 10, 2)->default(0); // Frais de transaction
             $table->enum('statut', ['en cours', 'annulé', 'complété'])->default('en cours'); // Champ pour le statut de la transaction
